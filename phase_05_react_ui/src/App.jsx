...
const NAV_LINKS = [
  ...
  { to: "/live-eval", label: "Tweet Analyser", icon: "🐦" },
...
function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 inset-x-0 z-50 nav-glass border-b transition-all duration-300
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div
            className="px-3 h-10 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600
        ...
        {/* API status */}
        <div
          className={`flex items-center gap-2 px-3.5 py-2 rounded-2xl text-xs font-semibold border shrink-0
                         ${
                           apiStatus === "online"
